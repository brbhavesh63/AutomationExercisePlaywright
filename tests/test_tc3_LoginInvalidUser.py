...
with open("C:\\Users\\Bhavesh\\PycharmProjects\\AutomationExercise\\data\\login_invalid_data.json") as f:
    test_data = json.load(f)
    user_credentials_list = test_data["user_credentials"]
    print(user_credentials_list)

@pytest.mark.parametrize('user_credential_data',user_credentials_list)
def test_LoginInvalidUser(user_credential_data,browserInstance):
    ...
    signuploginpage.verifyInvalidLoginValidationError()